...
resource createADForest 'Microsoft.Compute/virtualMachines/extensions@2022-11-01' = {
  ...
  properties: {
    ...
    settings: {
      ...
      ModulesUrl: uri(_artifactsLocation, 'DSC/CreateADPDC.zip?token=${_artifactsLocationSasToken}')
...
module updateVNetDNS 'nested/vnet-with-dns-server.bicep' = {
  scope: resourceGroup()
  name: 'UpdateVNetDNS'
  params: {
    virtualNetworkName: virtualNetworkName
